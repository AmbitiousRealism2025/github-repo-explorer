import{i as _,a as k,t as E,b as l,s as I,g as B,f as c,c as v}from"./errorBoundary-6mNU-65L.js";import{g as L}from"./api-B86XjMPz.js";_();k();const d=document.getElementById("repo-1"),u=document.getElementById("repo-2"),p=document.getElementById("repo-3"),f=document.getElementById("repo-4"),w=document.getElementById("compare-btn"),g=document.getElementById("loading-state"),h=document.getElementById("compare-results"),b=document.getElementById("empty-state"),$=document.getElementById("compare-header"),P=document.getElementById("compare-body"),N=document.getElementById("theme-toggle"),S=[{key:"stargazers_count",label:"Stars",format:c},{key:"forks_count",label:"Forks",format:c},{key:"open_issues_count",label:"Open Issues",format:c},{key:"subscribers_count",label:"Watchers",format:c},{key:"language",label:"Primary Language",format:e=>e||"N/A"},{key:"license",label:"License",format:e=>e?.spdx_id||"None"},{key:"created_at",label:"Created",format:e=>new Date(e).toLocaleDateString()},{key:"pushed_at",label:"Last Push",format:v},{key:"size",label:"Size",format:e=>`${(e/1024).toFixed(1)} MB`},{key:"default_branch",label:"Default Branch",format:e=>e},{key:"has_wiki",label:"Wiki",format:e=>e?"Yes":"No"},{key:"has_pages",label:"GitHub Pages",format:e=>e?"Yes":"No"},{key:"archived",label:"Archived",format:e=>e?"Yes":"No"}],m=e=>{switch(g.classList.add("hidden"),h.classList.add("hidden"),b.classList.add("hidden"),e){case"loading":g.classList.remove("hidden");break;case"results":h.classList.remove("hidden");break;case"empty":b.classList.remove("hidden");break}},T=(e,t)=>{if(!["stargazers_count","forks_count","subscribers_count"].includes(t))return null;let o=0,s=e[0][t]||0;return e.forEach((r,i)=>{const n=r[t]||0;n>s&&(s=n,o=i)}),o},j=e=>{$.innerHTML=`
