import{i as b,a as _,t as y,b as l,S as c,e as g,c as $}from"./errorBoundary-Bh1k4IQJ.js";b();_();const f=document.getElementById("collections-list"),C=document.getElementById("empty-state"),w=document.getElementById("create-collection-btn"),i=document.getElementById("collection-modal"),E=document.getElementById("modal-title"),k=document.getElementById("modal-close"),L=document.getElementById("modal-cancel"),I=document.getElementById("modal-save"),v=document.getElementById("collection-name"),m=document.getElementById("collection-description"),B=document.getElementById("theme-toggle");let s=null;const p=()=>{const t=c.getCollections();if(t.length===0){f.innerHTML="",C.classList.remove("hidden");return}C.classList.add("hidden"),f.innerHTML=t.map(e=>`
    <div class="collection-card" data-id="${e.id}">
      <div class="collection-card__header">
        <h3 class="collection-card__name">${g(e.name)}</h3>
      ...
      ${e.description?`<p class="collection-card__description">${g(e.description)}</p>`:""}
